...
const ButtonLink = ({ href, variant = "default", size = "sm", className = "", children, ...props }: ButtonLinkProps) => {
  ...
  const variants = {
    ...
    outline: "border border-white/20 bg-white/5 text-white backdrop-blur-xl hover:border-white/30 hover:bg-white/10",
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-2 -top-2 inset-x-0 -translate-x-full skew-x-12 bg-gradient-to-r from-transparent via-white/20 to-transparent transition-transform duration-1000 ease-out group-hover:translate-x-full" />
    </Link>
  );
};
